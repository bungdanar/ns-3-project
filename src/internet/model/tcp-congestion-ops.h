...
public:
   ...
   */
  virtual void
  IncreaseWindow (Ptr<TcpSocketState> tcb, uint32_t segmentsAcked)
  {
    NS_UNUSED (tcb);
   ...
   */
  virtual void
  CongestionStateSet (Ptr<TcpSocketState> tcb, const TcpSocketState::TcpCongState_t newState)
  {
    NS_UNUSED (tcb);
    NS_UNUSED (newState);
  }
   ...
   */
  virtual void
  CwndEvent (Ptr<TcpSocketState> tcb, const TcpSocketState::TcpCAEvent_t event)
  {
    NS_UNUSED (tcb);
    NS_UNUSED (event);
  }
   ...
   */
  virtual void
  CongControl (Ptr<TcpSocketState> tcb, const struct RateSample *rs)
  {
    NS_UNUSED (tcb);
    NS_UNUSED (rs);
  }
